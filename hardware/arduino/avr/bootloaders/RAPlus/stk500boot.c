...
static void sendchar1(char c);
static unsigned char recchar1(void);
...
//************************************************************************
static int	Serial_Available1(void)
{
...
static unsigned char recchar1(void)
{
	while (!(UART_STATUS_REG1 & (1 << UART_RECEIVE_COMPLETE1)))
	{
		// wait for data
	}
...
void	PrintDecInt(int theNumber, int digitCnt);
	...
	prog_char	gTextMsg_Explorer[]			PROGMEM	=	"Reef Angel Plus Controller Bootloader";
	prog_char	gTextMsg_Prompt[]			PROGMEM	=	"ReefAngel>";
	prog_char	gTextMsg_HUH[]				PROGMEM	=	"Unknown Command";
...
//*	Help messages
	...
	//prog_char	gTextMsg_HELP_MSG_W[]		PROGMEM	=	"W=Wifi Bypass";
	//prog_char	gTextMsg_HELP_MSG_W1[]		PROGMEM	=	"1=9600 baud";
	//prog_char	gTextMsg_HELP_MSG_W2[]		PROGMEM	=	"2=57600 baud";
	//prog_char	gTextMsg_HELP_MSG_W3[]		PROGMEM	=	"3=115200 baud";
...
/*
static void WifiBypass(void)
{
char			keepGoing;
unsigned char	theChar;
unsigned char	theCharMon[]="   ";
int itheCharMon=0;

	
	PrintFromPROGMEMln(gTextMsg_HELP_MSG_W1, 0);
	PrintFromPROGMEMln(gTextMsg_HELP_MSG_W2, 0);
	PrintFromPROGMEMln(gTextMsg_HELP_MSG_W3, 0);
	...
	while (keepGoing)
	{
		...
		{
			case '1':
				UART_BAUD_RATE_LOW1	=	UART_BAUD_SELECT(9600,F_CPU);
				PrintFromPROGMEMln(gTextMsg_HELP_MSG_W1, 2);
				keepGoing	=	false;
				break;
			case '2':
				UART_BAUD_RATE_LOW1	=	UART_BAUD_SELECT(57600,F_CPU);
				PrintFromPROGMEMln(gTextMsg_HELP_MSG_W2, 2);
				keepGoing	=	false;
				break;
			case '3':
				UART_BAUD_RATE_LOW1	=	UART_BAUD_SELECT(115200,F_CPU);
				PrintFromPROGMEMln(gTextMsg_HELP_MSG_W3, 2);
				keepGoing	=	false;
				break;
			default:
	...
	while (keepGoing)
	{
	  ...
	  {
		theChar = recchar();
		theCharMon[itheCharMon++]=theChar;
		if (itheCharMon==3) itheCharMon=0;
		if (theCharMon[0]=='!' && theCharMon[1]=='!' && theCharMon[2]=='!')
		{
			PrintNewLine();
			keepGoing=false;
		}
...
static void PrintHelp(void)
{
	...
	//PrintFromPROGMEMln(gTextMsg_HELP_MSG_W, 0);
}
