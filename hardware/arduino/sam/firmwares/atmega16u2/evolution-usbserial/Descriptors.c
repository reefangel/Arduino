...
USB_Descriptor_Device_t PROGMEM DeviceDescriptor =
{
	...
	.VendorID               = 0x1d50, // Openmoko.org
	.ProductID          	= 0x606e, // Reef Angel Evolution on board USB2Serial
...
//	.UnicodeString          = L"Arduino (www.arduino.cc)"
	.UnicodeString          = L"Reef Angel (www.reefangel.com)"
};
...
USB_Descriptor_String_t PROGMEM ProductString =
{
	...
	#elif (ARDUINO_MODEL_PID == REEFANGEL_EVOLUTION_PID)
		.Header                 = {.Size = USB_STRING_LEN(20), .Type = DTYPE_String},
			
		.UnicodeString          = L"Reef Angel Evolution"
