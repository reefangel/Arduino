...
public class GzippedJsonDownloaderTest {
  ...
  public void testJsonDownload() throws Exception {
    new GZippedJsonDownloader(downloader, new URL("http://www.reefangel.com/arduinoide/libraries/library_index.json"), new URL("http://www.reefangel.com/arduinoide/libraries/library_index.json.gz")).download(tempFile, new MultiStepProgress(1), "", new NoopProgressListener());
