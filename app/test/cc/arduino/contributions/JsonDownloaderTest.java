...
public class JsonDownloaderTest {
  ...
  public void testJsonDownload() throws Exception {
    new JsonDownloader(downloader, new URL("http://www.reefangel.com/arduinoide/libraries/library_index.json")).download(tempFile, new MultiStepProgress(1), "", new NoopProgressListener());
